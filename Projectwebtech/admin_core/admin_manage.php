        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview" id="menu-user">
                    <a href="#">
                        <i class="fa fa-folder"></i> <span>ข้อมูลแอดมิน</span> <i
                ...
                <li class="treeview" id="menu-tool-main">
                    ...
                    <ul class="treeview-menu">
                        <li id="beacon-receiver"><a href=""><i class="fa fa-folder-open"></i> จัดการข้อข้อมูลรายวิชา</a></li>
                ...
                <li class="treeview" id="menu-member_dog-main">
                    ...
                    <ul class="treeview-menu">
                        <li id="menu-member_dog"><a href=""><i class="fa fa-folder-open"></i> จัดดการข้อมูลนิสิต</a></li>
                        <!--                    <li id="menu-checking"><a href="#"><i class="fa fa-folder-open"></i> ตรวจสอบ/อนมุติ การจองจากสมาชิก</a></li>-->
                    </ul>
                </li>
            </ul>
